                                    ...
                                    <table border='0' cellpadding='0' cellspacing='0' role='presentation'
                                        ...
                                        <tr>
                                            <td align='center'
                                                style='font-size:0px;padding:10px 25px;word-break:break-word;'>
                                                <div style='color:#777777;font-family:Oxygen, Helvetica neue, sans-serif;font-size:14px;line-height:21px;text-align:center;'>
                                                    Для подтверждения аккаунта нажмите на кнопку с текстом "Подтвердить аккаунт".
                                                </div>
                                            </td>
                                        </tr>
                                    </table>
                                            ...
                                            <td style='background-color:#ffffff;border:1px solid #ccc;padding:50px 15px;vertical-align:top;'>
                                                <table border='0' cellpadding='0' cellspacing='0' role='presentation' style='' width='100%'>
                                                    ...
                                                    <tr><td align="center" style="font-size:0px;padding:10px 25px;word-break:break-word;">
                                                            <div style="color:#777777;font-family:Oxygen, Helvetica neue, sans-serif;font-size:14px;line-height:21px;text-align:center;">
                                                                <span>Если вы получили данное письмо после заказа на нашем сайте, то вам также нужно <span style="font-weight:700; color: #ff6f6f; font-size: 18px;">Подтвердить аккаунт</span></span>
                                                            </div>
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                            ...
                                                            <table border='0' cellpadding='0' cellspacing='0' role='presentation' style='border-collapse:separate;line-height:100%;'>
                                                                <tr>
                                                                    <td align='center' bgcolor='#ff6f6f' role='presentation' style='background-color:#ff6f6f;border:none;border-radius:5px;cursor:auto;padding:10px 25px;' valign='middle'>
                                                                        <a href='<?= $url ?>' style='background:#ff6f6f;color:#ffffff;font-family:Oxygen, Helvetica neue, sans-serif;font-size:14px;font-weight:400;line-height:21px;margin:0;text-decoration:none;text-transform:none;' target='_blank'>
                                                                            Подтвердить аккаунт
                                                                        </a>
                                                                    </td>
                                                                </tr>
