                            ...
                            <tr>
                                <td align='center' style='font-size:0px;padding:10px 25px;word-break:break-word;'>
                                    <div style='color:#777777;font-family:Oxygen, Helvetica neue, sans-serif;font-size:14px;line-height:21px;text-align:center;'>
                                        Для изменения пароля нажмите на кнопку "Изменить пароль".
                                        <br />
                                        Если после нажатия по кнопке у вас не открылось новое окно с изменением пароля, в таком случае скопируйте данную ссылку
                                        <strong>
                                            "<?= $url ?>"
                                        </strong>
                                        и вставьте в адресную строку Вашего браузера.
                                        (Если вы не должны были получать это письмо, пожалуйста, удалите его).
                                    </div>
                                </td>
                            </tr>
                        </table>
