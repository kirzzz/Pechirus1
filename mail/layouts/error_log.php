...
<head>
    ...
    <style type="text/css">
        ...
        #ko_socialBlock_3 .links-color a, #ko_socialBlock_3 .links-color a:link, #ko_socialBlock_3 .links-color a:visited, #ko_socialBlock_3 .links-color a:hover {
            color: #cccccc;
            color: #cccccc;
            text-decoration: underline
        }
...
<!--[if !(gte mso 16)]-->
<body bgcolor="#4f81bd" text="#ffffff" alink="#cccccc" vlink="#cccccc"
      style="margin: 0; padding: 0; background-color: #4f81bd; color: #ffffff;"><!--<![endif]-->
<center>
    <table role="presentation" class="vb-outer" width="100%" cellpadding="0" border="0" cellspacing="0"
      ...
      -->
                <div style="margin: 0 auto; max-width: 570px; -mru-width: 0px;">
                    <table role="presentation" border="0" cellpadding="0" cellspacing="9" bgcolor="#fac08f" width="570"
                           class="vb-row"
                           style="border-collapse: separate; width: 100%; background-color: #fac08f; mso-cellspacing: 9px; border-spacing: 9px; max-width: 570px; -mru-width: 0px;">
                                            ...
                                            <tr>
                                                <td width="100%" valign="top" align="center" class="links-color">
                                                    ...
                                                    <![endif]--><img border="0" hspace="0" align="center" vspace="0"
                                                                     ...
                                                                     src="https://mosaico.io/srv/f-evylh3j/img?src=https%3A%2F%2Fmosaico.io%2Ffiles%2Fevylh3j%2Fthe-error-of-a-frown-the-red-circular-plate-photos-24.png&amp;method=resize&amp;params=166%2Cnull">
      ...
      -->
        ...
        -->
                                        <table role="presentation" class="vb-content" border="0" cellspacing="9"
                                            ...
                                            <tbody>
                                            <tr>
                                                <td width="100%" valign="top" align="left" style="font-weight: normal; color: #000000; font-size: 18px; font-family: Arial, Helvetica, sans-serif; text-align: left;">
                                                    <span style="font-weight: normal;">Ошибка: <?= $error ?></span>
                                                </td>
                                            </tr>
                                            <tr>
                                                <td class="long-text links-color" width="100%" valign="top" align="left" style="font-weight: normal; color: #3f3f3f; font-size: 13px; font-family: Arial, Helvetica, sans-serif; text-align: left; line-height: normal;">
                                                    <p style="margin: 1em 0px; margin-bottom: 0px; margin-top: 0px;">Продукты: <?= $data ?></p>
                                                </td>
                                            </tr>
                                            <tr>
                                                <td valign="top" align="left">
                                                    <table role="presentation" cellpadding="6" border="0" align="left"
                                                           cellspacing="0"
                                                        ...
                                                        <tr>
                                                            <td width="auto" valign="middle" align="left"
                                                                bgcolor="#0f243e"
                                                                style="text-align: center; font-weight: normal; padding: 6px; padding-left: 18px; padding-right: 18px; background-color: #0f243e; color: #ffffff; font-size: 13px; font-family: Arial, Helvetica, sans-serif; border-radius: 4px;">
                                                                <a style="text-decoration: none; font-weight: normal; color: #ffffff; font-size: 13px; font-family: Arial, Helvetica, sans-serif;"
                                                                   target="_new" href="">Открыть продукт на сайте</a>
                                                            </td>
                                                        </tr>
                                                        </tbody>
                                                    </table>
    ...
    <table role="presentation" class="vb-outer" width="100%" cellpadding="0" border="0" cellspacing="0"
           bgcolor="#4f81bd" style="background-color: #4f81bd;" id="ko_socialBlock_3">
        <tbody>
        <tr>
            <td class="vb-outer" align="center" valign="top"
                style="padding-left: 9px; padding-right: 9px; font-size: 0;">
      ...
      -->
        ...
        --><!--
          --><!--[if (gte mso 9)|(lte ie 8)]>
                                    <td align="left" valign="top" width="276"><![endif]--><!--
      -->
                                    <div class="mobile-full"
                                        ...
                                        <table role="presentation" class="vb-content" border="0" cellspacing="9"
                                            ...
                                            <tr>
                                                <td class="long-text links-color" width="100%" valign="top" align="left"
                                                    style="font-weight: normal; color: #ffffff; font-size: 13px; font-family: Arial, Helvetica, sans-serif; text-align: left;">
                                        ...
                                        <table role="presentation" class="vb-content" border="0" cellspacing="9"
                                            ...
                                            <tr>
                                                <td width="100%" valign="top"
                                                    style="font-size: 6px; font-weight: normal; text-align: right;"
                                                    align="right" class="links-color socialLinks mobile-textcenter">

                                                    &nbsp;<a
                                                            style="display: inline-block; color: #cccccc; color: #cccccc; text-decoration: underline; background: url(data:image/gif;base64,R0lGODlhAQABAIAAAAAAAP///yH5BAEAAAAALAAAAAABAAEAAAIBRAA7), #3b5998; border-radius: 50px;"
                                                            target="_new" href=""><img border="0"
                                                                                       style="border: 0px; display: inline-block; vertical-align: top; padding-bottom: 0px;"
                                                                                       src="https://mosaico.io/templates/versafix-1/img/icons/fb-colors-96.png"
                                                                                       width="32" height="32"
                                                                                       alt="Facebook"></a>

                                                    &nbsp;<a
                                                            style="display: inline-block; color: #cccccc; color: #cccccc; text-decoration: underline; background: url(data:image/gif;base64,R0lGODlhAQABAIAAAAAAAP///yH5BAEAAAAALAAAAAABAAEAAAIBRAA7), #4099FF; border-radius: 50px;"
                                                            target="_new" href=""><img border="0"
                                                                                       style="border: 0px; display: inline-block; vertical-align: top; padding-bottom: 0px;"
                                                                                       src="https://mosaico.io/templates/versafix-1/img/icons/tw-colors-96.png"
                                                                                       width="32" height="32"
                                                                                       alt="Twitter"></a>

                                                    &nbsp;<a
                                                            style="display: inline-block; color: #cccccc; color: #cccccc; text-decoration: underline; background: url(data:image/gif;base64,R0lGODlhAQABAIAAAAAAAP///yH5BAEAAAAALAAAAAABAAEAAAIBRAA7), #d34836; border-radius: 50px;"
                                                            target="_new" href=""><img border="0"
                                                                                       style="border: 0px; display: inline-block; vertical-align: top; padding-bottom: 0px;"
                                                                                       src="https://mosaico.io/templates/versafix-1/img/icons/gg-colors-96.png"
                                                                                       width="32" height="32"
                                                                                       alt="Google"></a>
