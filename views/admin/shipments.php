    ...
    <div class="col-lg-5">
        <div class="card">
            ...
            <div class="card-body p-4">
                ...
                <div class="text-center">
                    <h3 class="mt-4">В разработке!</h3>
                    <p class="text-muted mb-0">Данная страница находится в разработке и совсем скоро появится на вашем сайте!</p>
                </div>
        ...
        <div class="row mt-3">
            <div class="col-12 text-center">
                <p class="text-white-50">Вернуться <a href="<?= \yii\helpers\Url::toRoute(['admin/index'])?>" class="text-white ml-1"><b>на главную</b></a></p>
            </div> <!-- end col -->
        </div>
        <!-- end row -->
