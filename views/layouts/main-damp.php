...
<a href="https://metrika.yandex.ru/stat/?id=31050401&amp;from=informer"
   target="_blank" rel="nofollow"><img src="https://informer.yandex.ru/informer/31050401/3_1_EFEFEFFF_EFEFEFFF_0_pageviews"
                                       style="width:88px; height:31px; border:0;" alt="Яндекс.Метрика" title="Яндекс.Метрика: данные за сегодня (просмотры, визиты и уникальные посетители)" class="ym-advanced-informer" data-cid="31050401" data-lang="ru" /></a>
<!-- /Yandex.Metrika informer -->
                            ...
                            <div class="main-menu menu-lh-1 main-menu-padding-1 menu-mrg-1">
                                <nav>
                                    <ul>
                                        ...
                                        <li data-catalog-container><a href="<?=Url::toRoute(['site/list'])?>">Каталог</a>
                                            <?php
                                            ...
                                            ?>
                                            <ul class="mega-menu-style-1 mega-menu-width menu-negative-mrg2">
                                                <?php foreach ($new_catalog as $index=>$group):?>
                                                    ...
                                                    <li data-catalog-parent="<?= $index ?>" class="<?= $class ?> mega-menu-sub-width100 back flex-column"><a <?= $index?'data-catalog-back="'.$index.'"':'' ?> class="menu-title" href="javascript:void(0)"><?= $index?'<i class="icofont-arrow-left mr-2"></i>'.$catalogs[array_search($index,array_column((array)$catalogs,'article'))]['name']:'Каталог' ?></a>
                                                        <ul class="d-flex mega-menu-style-1 mega-menu-width menu-negative-mrg flex-column" style="display:grid!important; grid-gap: 0 1rem; grid-template-columns: 1fr 1fr">
                                                            <?php foreach ($group as $article=>$name):?>
                                                                <li data-catalog-article="<?= $article ?>" class="<?= isset($get['catalog'])?($catalogs[array_search($get['catalog'],array_column((array)$catalogs,'id'))]['article'] == $article?'active':''):'' ?> d-flex justify-content-between align-items-center">
                                                                    <a href="<?= Url::toRoute(['site/list','catalog'=>$catalogs[array_search($article,array_column((array)$catalogs,'article'))]['id']])?>"><?= $name ?></a><?= isset($new_catalog[$article])?'<button data-catalog-article-open="'.$article.'" class="btn btn-outline-light badge ml-2"><i class="icofont-arrow-right"></i></button>':'' ?>
                                                                </li>
                                                            <?php endforeach; ?>
                                                        </ul>
                                                    </li>
                                        ...
                                        <li><a href="<?=Url::toRoute(['site/list'])?>">Дополнительно</a>
                                            <ul class="mega-menu-style-1 mega-menu-width menu-negative-mrg">
                                                <li class="mega-menu-sub-width100"><a class="menu-title" href="javascript:void(0)">Дополнительные страницы</a>
                                                    <ul>
                                                        <li><a href="<?=Url::toRoute(['site/about-us'])?>">О нас</a></li>
                                                        <li><a href="<?=Url::toRoute(['site/contact'])?>">Контакты</a></li>
                                                        <li><a href="<?=Url::toRoute(['site/calculator'])?>">Калькулятор</a></li>
        ...
        <div class="clickalbe-sidebar-wrap">
            ...
            <div class="mobile-menu-content-area sidebar-content-100-percent">
                ...
                <div class="clickable-mainmenu-wrap clickable-mainmenu-style1">
                    <nav>
                        <ul>
                            <li class="has-sub-menu"><a href="<?=Url::to('index')?>">Главная</a></li>
                            <li class="has-sub-menu pb-2"><div class="d-flex justify-content-between"><a href="<?=Url::toRoute(['site/list'])?>" style="line-height: 150%">Каталог</a></div>
                                <?php
                                ...
                                function showTree($arr, $data)
                                {
                                    ...
                                    foreach ($arr as $key => $v) {
                                        ...
                                        echo '<li '.(is_array($v)?'class="has-sub-menu pb-2"':'').'><div class="d-flex justify-content-between"><a href="'.Url::toRoute(['site/list','catalog'=>$item['id']]).'">'.$item['name'].'</a></div>';
                                        if (!is_array($v)) {
                                            echo '</li>';
                                        } else {
                                            echo '<ul class="sub-menu-2">' . showTree($v, $data) . '</ul></li>';
                                        }
                                    }
                                    echo '</ul>';
                                }
                            ...
                            <li class="has-sub-menu pb-2"><div class="d-flex justify-content-between"><a href="javascript:void(0)" style="line-height: 150%">Дополнительно</a></div>
                                <ul class="sub-menu-2">
                                    <li><div class="d-flex"><a href="<?=Url::toRoute(['site/about-us'])?>">О нас</a></div></li>
                                    <li><div class="d-flex"><a href="<?=Url::toRoute(['site/contact'])?>">Контакты</a></div></li>
                                    <li><div class="d-flex"><a href="<?=Url::toRoute(['site/calculator'])?>">Калькулятор</a></div></li>
                                    <li><div class="d-flex"><a href="<?=Url::toRoute(['site/payment-and-delivery'])?>">Оплата и Доставка</a></div></li>
                                </ul>
                            </li>
                            <li><a href="<?=Url::toRoute(['site/order-tracking'])?>">Отследить заказ</a></li>
                        </ul>
