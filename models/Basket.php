...
class Basket extends \yii\db\ActiveRecord
{
    ...
    {
        if (!$insert) {
            (new Log(['type_id' => $this->id,'type' => Log::TYPE_BASKET,'action' => Log::ACTION_UPDATE,'info' => json_encode((array)$changedAttributes,JSON_UNESCAPED_UNICODE)]))->save();
        }else{
            (new Log(['type_id' => $this->id,'type' => Log::TYPE_BASKET,'action' => Log::ACTION_CREATE,'info' => json_encode((array)$this->attributes,JSON_UNESCAPED_UNICODE)]))->save();
        }
